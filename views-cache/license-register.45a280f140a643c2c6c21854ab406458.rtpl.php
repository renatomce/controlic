  ...
  <div id="license-window" class="row">
  	<div class="col-md-12">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Registrar liberação de licença</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/admin/clients/<?php echo htmlspecialchars( $client["idclient"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/register" method="post">
          <div class="box-body">
            <div class="form-group">
                <label for="deslicexpires">Expirar em</label>
